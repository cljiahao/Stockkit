 ...
 * client; under RLS (admins_admin_select) the row is visible only to admins,
 * and a non-admin simply gets no row — so presence of a row is the
 * membership test.
 */
 ...
 * non-admins get a 404 — the route's existence isn't revealed.
 */
