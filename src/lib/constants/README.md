...
page and the account menu's "Plan" nav item. `PAGE_ROUTES.ADMIN`/`ADMIN_VENDORS`/`ADMIN_ACTIVITY`
(`/admin`, `/admin/vendors`, `/admin/activity`) back the Merqo-team admin console's nav tabs
