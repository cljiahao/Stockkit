...
- `page.tsx` — `AdminVendorsPage`: fetches `listVendors()` and renders a vendor table (`ElevatedCard`-wrapped, "No vendors yet." dashed-border empty state) with plan badges and `VendorPlanToggle`.
